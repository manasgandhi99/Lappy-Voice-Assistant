...
IFontDisp = Font
__all__ = [ 'OLE_XSIZE_PIXELS', 'Color', 'Default', 'Picture',
           'OLE_OPTEXCLUSIVE', 'VgaColor', 'OLE_CANCELBOOL',
           'FONTSIZE', 'Font', 'IFontDisp', 'Checked',
           'FONTUNDERSCORE', 'OLE_TRISTATE', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_XPOS_PIXELS', 'OLE_XSIZE_HIMETRIC',
           'OLE_XSIZE_CONTAINER', 'IPicture', 'OLE_HANDLE',
           'Monochrome', 'StdFont', 'FONTSTRIKETHROUGH', 'FONTITALIC',
           'StdPicture', 'OLE_YPOS_HIMETRIC', 'OLE_XPOS_HIMETRIC',
           'FONTBOLD', 'OLE_YPOS_CONTAINER', 'Gray',
           'IFontEventsDisp', 'FONTNAME', 'LoadPictureConstants',
           'OLE_XPOS_CONTAINER', 'IFont', 'OLE_COLOR', 'Unchecked',
           'OLE_YSIZE_HIMETRIC', 'OLE_YSIZE_CONTAINER',
           'OLE_YSIZE_PIXELS', 'IPictureDisp', 'OLE_YPOS_PIXELS',
           'FontEvents']
